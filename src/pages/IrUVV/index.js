...
export default function IrUVV() {
    const navigation = useNavigation();

    return (
        <ScrollView style={styles.container}>
          <Animatable.View animation="fadeInLeft" delay={500} style={styles.containerHeader}>
            <Text style={styles.message}>Caronas Ir para UVV</Text>
          </Animatable.View>
          ...
          <Animatable.View animation="fadeInUp" style={styles.containerForm}>
            <ScrollView>
                <TouchableOpacity style={styles.caixa}>
                    ...
                    <Text style={styles.texto}>De: Vitoria</Text>
                    <Text style={styles.texto}>Para: UVV</Text>
                    <Text style={styles.texto}>Data: 24/05/2023 19:00</Text>
                ...
                <TouchableOpacity style={styles.caixa}>
                    ...
                    <Text style={styles.texto}>De: Jardin da Penha</Text>
                    <Text style={styles.texto}>Para: UVV</Text>
                ...
                <TouchableOpacity style={styles.caixa}>
                    ...
                    <Text style={styles.texto}>De: Cnetro Vila Velha</Text>
                ...
                <TouchableOpacity style={styles.caixa}>
                    ...
                    <Text style={styles.texto}>De: Santa Maria de Jetibá</Text>
                    <Text style={styles.texto}>Para: UVV</Text>
