...
export default function VoltarUVV() {
    const navigation = useNavigation();

    return (
        <ScrollView style={styles.container}>
          <Animatable.View animation="fadeInLeft" delay={500} style={styles.containerHeader}>
            <Text style={styles.message}>Caronas da UVV</Text>
          </Animatable.View>
    
          <Animatable.View animation="fadeInUp" style={styles.containerForm}>
            <ScrollView>
                <TouchableOpacity style={styles.caixa} onPress={() => navigation.navigate("DetalheCarona")}>
                    <Text style={styles.texto}>Motorista: João Paulo</Text>
                    <Text style={styles.texto}>De: UVV</Text>
                    <Text style={styles.texto}>Para: Jardin da Penha</Text>
                ...
                <TouchableOpacity style={styles.caixa} onPress={() => navigation.navigate("DetalheCarona")}>
                    ...
                    <Text style={styles.texto}>De: UVV</Text>
                    <Text style={styles.texto}>Para: Vitoria</Text>
                ...
                <TouchableOpacity style={styles.caixa} onPress={() => navigation.navigate("DetalheCarona")}>
                    ...
                    <Text style={styles.texto}>De: UVV</Text>
                    <Text style={styles.texto}>Para: Serra</Text>
                ...
                <TouchableOpacity style={styles.caixa} onPress={() => navigation.navigate("DetalheCarona")}>
                    ...
                    <Text style={styles.texto}>De: UVV</Text>
                    <Text style={styles.texto}>Para: Centro</Text>
